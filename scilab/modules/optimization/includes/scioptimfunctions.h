...
void C2F(fuclid)(int *n, double *x, double *y, double *ps, int *ti, float *tr, double *td);
void C2F(ctonb)(int *n, double *u, double *v, int *ti, float *tr, double *td);
void C2F(ctcab)(int *n, double *u, double *v, int *ti, float *tr, double *td);
