            ...
            *_pDoubleOut = new Double(_pDouble2->getDims(), _pDouble2->getDimsArray(), true);
            ...
            if (bComplex1 == false && bComplex2 == false)
            {
                iPowerRealScalarByRealMatrix(
                    _pDouble1->getFirst(),
                    _pDouble2->get(), _pDouble2->getSize(),
            ...
            else if (bComplex1 == false && bComplex2 == true)
            {
                iPowerRealScalarByComplexMatrix(
                    _pDouble1->getFirst(),
                    _pDouble2->get(), _pDouble2->getImg(), _pDouble2->getSize(),
...
int DotPowerSparseByDouble(Sparse* _pSp, Double* _pDouble, InternalType** _pOut)
{
    if (_pDouble->isEmpty())
    {
        //sp .^ []
...
int DotPowerDoubleByDouble(Double* _pDouble1, Double* _pDouble2, Double** _pDoubleOut)
{
    ...
    {
        *_pDoubleOut = static_cast<Double*>(_pDouble1->clone());
    }
