...
template<>
InternalType* dotdiv_S_SC<Double, Double, Double>(Double *_pL, Double *_pR)
{
    Double* pOut = _pR->getRef() > 0 ? new Double(0.0, 0.0) : _pR;
    dotdiv(_pL->get(), 1, _pR->getFirst(), _pR->getImgFirst(), pOut->get(), pOut->getImg());
    return pOut;
}

template<>
InternalType* dotdiv_SC_SC<Double, Double, Double>(Double *_pL, Double *_pR)
{
    Double* pOut = _pL->getRef() > 0 ? (_pR->getRef() > 0 ? new Double(0.0, 0.0) : _pR) : _pL;
    dotdiv(_pL->getFirst(), _pL->getImgFirst(), 1, _pR->getFirst(), _pR->getImgFirst(), pOut->get(), pOut->getImg());
    return pOut;
}
...
template<>
InternalType* dotdiv_MC_S<Double, Double, Double>(Double *_pL, Double *_pR)
{
    Double* pOut = _pL->getRef() > 0 ? new Double(_pL->getDims(), _pL->getDimsArray(), true) : _pL;
    dotdiv(_pL->get(), _pL->getImg(), (size_t)_pL->getSize(), _pR->getFirst(), pOut->get(), pOut->getImg());
    return pOut;
}

template<>
InternalType* dotdiv_MC_SC<Double, Double, Double>(Double *_pL, Double *_pR)
{
    Double* pOut = _pL->getRef() > 0 ? new Double(_pL->getDims(), _pL->getDimsArray(), true) : _pL;
    dotdiv(_pL->get(), _pL->getImg(), (size_t)_pL->getSize(), _pR->getFirst(), _pR->getImgFirst(), pOut->get(), pOut->getImg());
    return pOut;
}

// specializations for Double (Matrix ./ Matrix)
template<>
...
template<>
InternalType* dotdiv_M_MC<Double, Double, Double>(Double *_pL, Double *_pR)
{
    int iDimsL = _pL->getDims();
    int iDimsR = _pR->getDims();
    ...
    dotdiv(_pL->get(), (size_t)_pL->getSize(), _pR->get(), _pR->getImg(), pOut->get(), pOut->getImg());
    return pOut;
}

template<>
InternalType* dotdiv_MC_MC<Double, Double, Double>(Double *_pL, Double *_pR)
{
    int iDimsL = _pL->getDims();
    int iDimsR = _pR->getDims();
    ...
    dotdiv(_pL->get(), _pL->getImg(), (size_t)_pL->getSize(), _pR->get(), _pR->getImg(), pOut->get(), pOut->getImg());
    return pOut;
}
...
InternalType* dotdiv_M_SC(T *_pL, U *_pR)
{
    ...
    dotdiv(_pL->get(), pOut->getSize(), _pR->getFirst(), _pR->getImgFirst(), pOut->get(), pOut->getImg());
    return pOut;
}
...
{
    O* pOut = new O(_pL->getDims(), _pL->getDimsArray(), true);
    dotdiv(_pL->get(), _pL->getImg(), pOut->getSize(), _pR->getFirst(), pOut->get(), pOut->getImg());
    return pOut;
}
...
{
    O* pOut = new O(_pL->getDims(), _pL->getDimsArray(), true);
    dotdiv(_pL->get(), _pL->getImg(), pOut->getSize(), _pR->getFirst(), _pR->getImgFirst(), pOut->get(), pOut->getImg());
    return pOut;
}
...
InternalType* dotdiv_S_M(T *_pL, U *_pR)
{
    ...
    dotdiv(_pL->getFirst(), (size_t)pOut->getSize(), _pR->get(), pOut->get());
    return pOut;
}
...
InternalType* dotdiv_S_MC(T *_pL, U *_pR)
{
    ...
    dotdiv(_pL->getFirst(), pOut->getSize(), _pR->get(), _pR->getImg(), pOut->get(), pOut->getImg());
    return pOut;
}
...
{
    O* pOut = (O*)_pR->clone();
    dotdiv(_pL->getFirst(), 1, _pR->getFirst(), _pR->getImgFirst(), pOut->get(), pOut->getImg());
    return pOut;
}
//Scalar complex ./ x
template<class T, class U, class O>
...
{
    O* pOut = new O(_pR->getDims(), _pR->getDimsArray(), true);
    dotdiv(_pL->getFirst(), _pL->getImgFirst(), pOut->getSize(), _pR->get(), pOut->get(), pOut->getImg());
    return pOut;
}
...
{
    O* pOut = new O(_pR->getDims(), _pR->getDimsArray(), true);
    dotdiv(_pL->getFirst(), _pL->getImgFirst(), pOut->getSize(), _pR->get(), _pR->getImg(), pOut->get(), pOut->getImg());
    return pOut;
}
...
{
    O* pOut = new O(0.0, 0.0);
    dotdiv(_pL->getFirst(), _pL->getImgFirst(), 1 , _pR->getFirst(), pOut->get(), pOut->getImg());
    return pOut;
}
...
InternalType* dotdiv_M_M<Sparse, Sparse, Sparse>(Sparse* _pL, Sparse* _pR)
{
    ...
    {
        Sparse* pOut = NULL;
        std::complex<double> c(_pL->getImgFirst());
        Double* pL = NULL;
        if (c.imag())
        {
    ...
    {
        Sparse* pOut = NULL;
        std::complex<double> c(_pR->getImgFirst());
        Double* pR = NULL;
        if (c.imag())
        {
...
InternalType* dotdiv_M_M<Double, Sparse, Sparse>(Double* _pL, Sparse* _pR)
{
    ...
    if (_pL->isScalar())
    {
        ...
        if (_pL->isComplex())
        {
            ...
            std::complex<double> stComplex(_pL->getFirst(), _pL->getImgFirst());
        ...
        else
        {
            ...
            for (int i = 0 ; i < iSizeOut ; i++)
            {
                if (_pR->get(i) != 0)
                {
                    pTemp->set(i, _pL->getFirst(), false);
                }
            }
        }
...
InternalType* dotdiv_M_M<Sparse, Double, Sparse>(Sparse* _pL, Double* _pR)
{
    ...
    if (_pR->isScalar())
    {
        ...
        if (_pR->isComplex())
        {
            ...
            std::complex<double> stComplex(_pR->getFirst(), _pR->getImgFirst());
            for (int i = 0 ; i < iSizeOut ; i++)
            {
                if (_pL->get(i) != 0)
                {
        ...
        else
        {
            ...
            for (int i = 0 ; i < iSizeOut ; i++)
            {
                if (_pL->get(i) != 0)
                {
                    pTemp->set(i, _pR->getFirst(), false);
                }
            }
        }
