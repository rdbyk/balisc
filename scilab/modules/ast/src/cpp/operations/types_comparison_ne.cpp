...
InternalType* compnoequal_M_S(T *_pL, U *_pR)
{
    ...
    compnoequal(_pL->get(), (size_t)pOut->getSize(), _pR->getFirst(), pOut->get());
    return pOut;
}
...
{
    O* pOut = new O(_pL->getDims(), _pL->getDimsArray());
    compnoequal(_pL->get(), pOut->getSize(), _pR->getFirst(), _pR->getImgFirst(), pOut->get());
    return pOut;
}
...
{
    O* pOut = new O(_pL->getDims(), _pL->getDimsArray());
    compnoequal(_pL->get(), _pL->getImg(), pOut->getSize(), _pR->getFirst(), pOut->get());
    return pOut;
}
...
{
    O* pOut = new O(_pL->getDims(), _pL->getDimsArray());
    compnoequal(_pL->get(), _pL->getImg(), pOut->getSize(), _pR->getFirst(), _pR->getImgFirst(), pOut->get());
    return pOut;
}
...
{
    O* pOut = new O(_pR->getDims(), _pR->getDimsArray());
    compnoequal(_pL->getFirst(), (size_t)pOut->getSize(), _pR->get(), pOut->get());
    return pOut;
}
...
{
    O* pOut = new O(_pR->getDims(), _pR->getDimsArray());
    compnoequal(_pL->getFirst(), pOut->getSize(), _pR->get(), _pR->getImg(), pOut->get());
    return pOut;
}
...
{
    O* pOut = new O(1, 1);
    compnoequal(_pL->getFirst(), _pR->getFirst(), pOut->get());
    return pOut;
}
...
{
    O* pOut = new O(1, 1);
    compnoequal(_pL->get(), 1, _pR->getFirst(), _pR->getImgFirst(), pOut->get());
    return pOut;
}
...
InternalType* compnoequal_S_IC(T *_pL, U *_pR)
{
    ...
    compnoequal(_pL->getFirst(), 1, _pR->get(), _pR->getImg(), pOut->get());
    return pOut;
}
...
{
    O* pOut = new O(_pR->getDims(), _pR->getDimsArray());
    compnoequal(_pL->getFirst(), _pL->getImgFirst(), pOut->getSize(), _pR->get(), pOut->get());
    return pOut;
}
...
{
    O* pOut = new O(_pR->getDims(), _pR->getDimsArray());
    compnoequal(_pL->getFirst(), _pL->getImgFirst(), pOut->getSize(), _pR->get(), _pR->getImg(), pOut->get());
    return pOut;
}
...
{
    O* pOut = new O(false);
    compnoequal(_pL->getFirst(), _pL->getImgFirst(), _pR->getFirst(), _pR->getImgFirst(), pOut->get());
    return pOut;
}
        ...
        if (_pL->isComplex())
        {
            if (_pR->isComplex())
            {
                ...
                for (int i = 0; i < iSize; i++)
                {
                    ...
                    {
                        compnoequal((double)pSPR[i]->getFirst(), (double)pSPR[i]->getImgFirst(), (double)pdblEye->get_(i), (double)pdblEye->getImg_(i), &(pbOut->get()[i]));
                    }
                }
            }
            else
            {
                ...
                for (int i = 0; i < iSize; i++)
                {
                    ...
                    {
                        compnoequal((double)pSPR[i]->getFirst(), (double)pSPR[i]->getImgFirst(), (double)pdblEye->get_(i), (double)0, &(pbOut->get()[i]));
                    }
                }
            }
        }
        else
        {
            if (_pR->isComplex())
            {
                ...
                for (int i = 0; i < iSize; i++)
                {
                    ...
                    {
                        compnoequal((double)pSPR[i]->getFirst(), (double)0, (double)pdblEye->get_(i), (double)pdblEye->getImg_(i), &(pbOut->get()[i]));
                    }
                }
            }
            else
            {
                ...
                for (int i = 0; i < iSize; i++)
                {
                    ...
                    {
                        compnoequal((double)pSPR[i]->getFirst(), (double)pdblEye->get_(i), &(pbOut->get()[i]));
                    }
                }
            }
        }
        ...
        if (_pL->isComplex())
        {
            if (_pR->isComplex())
            {
                for (int i = 0; i < iSize; i++)
                {
                    ...
                    {
                        compnoequal((double)pSPR[i]->getFirst(), (double)pSPR[i]->getImgFirst(), (double)_pR->getFirst(), (double)_pR->getImgFirst(), &(pbOut->get()[i]));
                    }
                }
            }
            else
            {
                for (int i = 0; i < iSize; i++)
                {
                    ...
                    {
                        compnoequal((double)pSPR[i]->getFirst(), (double)pSPR[i]->getImgFirst(), (double)_pR->getFirst(), (double)0, &(pbOut->get()[i]));
                    }
                }
            }
        }
        else
        {
            if (_pR->isComplex())
            {
                for (int i = 0; i < iSize; i++)
                {
                    ...
                    {
                        compnoequal((double)pSPR[i]->getFirst(), (double)0, (double)_pR->getFirst(), (double)_pR->getImgFirst(), &(pbOut->get()[i]));
                    }
                }
            }
            else
            {
                for (int i = 0; i < iSize; i++)
                {
                    ...
                    {
                        compnoequal((double)pSPR[i]->getFirst(), (double)_pR->getFirst(), &(pbOut->get()[i]));
                    }
                }
            }
        }
        ...
        if (pSPR[0]->getSize() == 1)
        {
            if (_pL->isComplex())
            {
                if (_pR->isComplex())
                {
                    for (int i = 0; i < iSize; i++)
                    {
                        compnoequal((double)pSPR[0]->getFirst(), (double)pSPR[0]->getImgFirst(), (double)_pR->get_(i), (double)_pR->getImg_(i), &(pbOut->get()[i]));
                    }
                }
                else
                {
                    for (int i = 0; i < iSize; i++)
                    {
                        compnoequal((double)pSPR[0]->getFirst(), (double)pSPR[0]->getImgFirst(), (double)_pR->get_(i), (double)0, &(pbOut->get()[i]));
                    }
                }
            }
            else
            {
                if (_pR->isComplex())
                {
                    for (int i = 0; i < iSize; i++)
                    {
                        compnoequal((double)pSPR[0]->getFirst(), (double)0, (double)_pR->get_(i), (double)_pR->getImg_(i), &(pbOut->get()[i]));
                    }
                }
                else
                {
                    for (int i = 0; i < iSize; i++)
                    {
                        compnoequal((double)pSPR[0]->getFirst(), (double)_pR->get_(i), &(pbOut->get()[i]));
                    }
                }
        ...
        if (_pL->isComplex())
        {
            if (_pR->isComplex())
            {
                for (int i = 0; i < iSize; i++)
                {
                    ...
                    {
                        compnoequal((double)pSPR[i]->getFirst(), (double)pSPR[i]->getImgFirst(), (double)_pR->get_(i), (double)_pR->getImg_(i), &(pbOut->get()[i]));
                    }
                }
            }
            else
            {
                for (int i = 0; i < iSize; i++)
                {
                    ...
                    {
                        compnoequal((double)pSPR[i]->getFirst(), (double)pSPR[i]->getImgFirst(), (double)_pR->get_(i), (double)0, &(pbOut->get()[i]));
                    }
                }
            }
        }
        else
        {
            if (_pR->isComplex())
            {
                for (int i = 0; i < iSize; i++)
                {
                    ...
                    {
                        compnoequal((double)pSPR[i]->getFirst(), (double)0, (double)_pR->get_(i), (double)_pR->getImg_(i), &(pbOut->get()[i]));
                    }
                }
            }
            else
            {
                for (int i = 0; i < iSize; i++)
                {
                    ...
                    {
                        compnoequal((double)pSPR[i]->getFirst(), (double)_pR->get_(i), &(pbOut->get()[i]));
                    }
                }
            }
        }
...
types::InternalType* compnoequal_M_M<GraphicHandle, GraphicHandle, Bool>(GraphicHandle* _pL, GraphicHandle* _pR)
{
    ...
    {
        Bool* pOut = new Bool(_pR->getDims(), _pR->getDimsArray());
        compnoequal(_pL->getFirst(), _pR->getSize(), _pR->get(), pOut->get());
        return pOut;
    }
    ...
    {
        Bool* pOut = new Bool(_pL->getDims(), _pL->getDimsArray());
        compnoequal(_pR->getFirst(), _pL->getSize(), _pL->get(), pOut->get());
        return pOut;
    }
