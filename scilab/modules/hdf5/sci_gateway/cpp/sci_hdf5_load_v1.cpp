...
static bool import_delete_v1(int* pvCtx, hid_t _iDatasetId, int _iItemPos, int *_piAddress, char *_pstVarname);
...
static bool import_data_v1(int* pvCtx, hid_t _iDatasetId, int _iItemPos, int *_piAddress, char *_pstVarname)
{
    ...
    switch (iVarType)
    {
        ...
        case sci_delete:
        {
            bRet = import_delete_v1(pvCtx, _iDatasetId, _iItemPos, _piAddress, _pstVarname);
            break;
        }
        case sci_undefined:
        {
