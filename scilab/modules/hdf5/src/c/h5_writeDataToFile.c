...
int writeDoubleComplexMatrix6(hid_t parent, const char* name, int dims, int* pdims, double* real, double* img, hid_t xfer_plist_id)
{
    hid_t space = 0;
    hid_t dset = 0;
    herr_t status = 0;
...
int writeDelete(hid_t parent, const char* name, hid_t xfer_plist_id)
{
    hsize_t piDims[1] = {1};
    herr_t status = 0;
    hid_t iSpace = 0;
