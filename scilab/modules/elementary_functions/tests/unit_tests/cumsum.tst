...
assert_checkerror("cumsum(d, ""orient"")", [], 110);
assert_checkerror("cumsum(d, [""r"", ""c""])", [], 102);

//==============================================================================
// matrices of integer
i = uint8(d);

assert_checkerror("cumsum(i, ""orient"")", [], 110);
assert_checkerror("cumsum(i, [""r"", ""c""])", [], 102);
assert_checkerror("cumsum(i,""r"", ""nat"")", [], 110);
assert_checkerror("cumsum(i,""r"", [""nat"" ""dble""])", [], 102);
assert_checkerror("cumsum(i,""orient"", ""t"")", [], 110);
assert_checkerror("cumsum(i,1,1)", [], 91);
...
assert_checkerror("cumsum(d, ""orient"")", [], 110);
assert_checkerror("cumsum(d, [""r"", ""c""])", [], 102);
assert_checkerror("cumsum(d,""r"", ""nat"")", [], 110)
assert_checkerror("cumsum(d,""r"", [""nat"" ""dble""])", [], 102);
assert_checkerror("cumsum(d,""orient"", ""t"")", [], 110);
assert_checkerror("cumsum(d,1,1)", [], 91);
