...
void int3d_f(double*, int*, double*);
...
void bvode_gsub(int*, double*, double*);
void bvode_dgsub(int*, double*, double*);
void bvode_fsub(double*, double*, double*);
void bvode_dfsub(double*, double*, double*);
void bvode_guess(double*, double*, double*);
...
void impl_f(int*, double*, double*, double*, double*, int*);
void impl_g(int*, double*, double*, double*, double*, double*, int*);
void impl_jac(int*, double*, double*, double*, double*, double*, double*, int*);
...
void dassl_f(double*, double*, double*, double*, int*, double*, int*);
void dassl_jac(double*, double*, double*, double*, double*, double*, int*);
...
void dasrt_g(int*, double*, double*, int*, double*, double*, int*);
...
void daskr_psol(int*, double*, double*, double*, double*, double*, double*, double*, double*, int*, double*, double*, int*, double*, int*);
void daskr_pjac(double*, int*, int*, double*, double*, double*, double*, double*, double*, double*, double*, double*, int*, int*, double*, int*);
