...
lang = "fr_FR"; 
if setlanguage(lang), assert_checkequal(gettext(msg), "Initialisation :"), end
lang = "fr";
if setlanguage(lang), assert_checkequal(gettext(msg), "Initialisation :"), end
lang = "en";
if setlanguage(lang), assert_checkequal(gettext(msg), msg), end
lang = "en_US";
if setlanguage(lang), assert_checkequal(gettext(msg), msg), end

addlocalizationdomain("tbx", "SCI/modules/localization/tests/unit_tests/locale");
if setlanguage("fr_FR")
...
lang="en_US";
if setlanguage(lang)
    domain="fake_domain"; msg="Localization does not exist";
...
lang="fr_FR";
if setlanguage(lang)
    domain="scilab"; msg="Startup execution:";
...
lang="fr_FR";
if setlanguage(lang)
    domain="fake_domain"; msg="Startup execution:";
    if gettext(domain,msg) == "Initialisation :" then pause, end
end
...
// Check if it is working with a bad domain & good msgid
lang="en_US"; if setlanguage(lang)
    domain="fake_domain"; msg="Startup execution:";
    if gettext(domain,msg) <> msg then pause, end
end
